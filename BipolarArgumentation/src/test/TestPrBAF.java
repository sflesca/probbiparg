...
public class TestPrBAF {
	public static void main(String[] args) {
		...
		System.out.println("---------------------");
		System.out.println("Tempo impiegato al calcolo con iteratore a complessit� spaziale esponenziale " + (t3 - t) + " ms");
		long t4 = System.currentTimeMillis();

		System.out.println("Tempo impiegato al calcolo con iteratore a complessit� spaziale costante  " + (t4 - t2) + " ms");
